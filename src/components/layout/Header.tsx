        ...
        <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
          ...
          <div className="relative" ref={notificationRef}>
            ...
            >
              <Bell size={20} />
              {unreadCount > 0 && (
                <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] bg-red-600 px-1 text-white text-[10px] rounded-full flex items-center justify-center border-2 border-white dark:border-slate-900 font-black animate-in zoom-in duration-300">
              ...
              {showNotifications && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full p-3 text-center border-t border-slate-100 dark:border-slate-800 bg-slate-50/20 dark:bg-slate-800/20 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all group"
                  >
